void main(List<String> arguments) {
  ...
  print(
      'Father bear has gained ${fatherBear.weightGaining(fatherBear.weightGain,fatherBear.hourOfSleep)} pounds of weight.');
  print('The type of the object : ${fatherBear.weightGain.runtimeType}');
  var weightGained = fatherBear.weightGain.toString();
  print(
